...
var format_adm_kabkota_fix_geometri_2 = new ol.format.GeoJSON();
var features_adm_kabkota_fix_geometri_2 = format_adm_kabkota_fix_geometri_2.readFeatures(json_adm_kabkota_fix_geometri_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_adm_kabkota_fix_geometri_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_adm_kabkota_fix_geometri_2.addFeatures(features_adm_kabkota_fix_geometri_2);
var lyr_adm_kabkota_fix_geometri_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_adm_kabkota_fix_geometri_2, 
                style: style_adm_kabkota_fix_geometri_2,
                popuplayertitle: "adm_kabkota_fix_geometri",
                interactive: true,
    title: 'adm_kabkota_fix_geometri<br />\
    <img src="styles/legend/adm_kabkota_fix_geometri_2_0.png" /> 3655 - 14536<br />\
    <img src="styles/legend/adm_kabkota_fix_geometri_2_1.png" /> 14536 - 20502<br />\
    <img src="styles/legend/adm_kabkota_fix_geometri_2_2.png" /> 20502 - 23779<br />\
    <img src="styles/legend/adm_kabkota_fix_geometri_2_3.png" /> 23779 - 33930<br />\
    <img src="styles/legend/adm_kabkota_fix_geometri_2_4.png" /> 33930 - 389916<br />'
        });

lyr_2021_0.setVisible(true);lyr_2022_1.setVisible(true);lyr_adm_kabkota_fix_geometri_2.setVisible(true);
var layersList = [lyr_2021_0,lyr_2022_1,lyr_adm_kabkota_fix_geometri_2];
...
lyr_adm_kabkota_fix_geometri_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'WADMKK': 'WADMKK', 'WADMPR': 'WADMPR', 'LUAS': 'LUAS', 'GIS_JM_PST': 'GIS_JM_PST', 'GIS_NM_INS': 'GIS_NM_INS', });
...
lyr_adm_kabkota_fix_geometri_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'WADMKK': 'TextEdit', 'WADMPR': 'TextEdit', 'LUAS': 'TextEdit', 'GIS_JM_PST': 'TextEdit', 'GIS_NM_INS': 'TextEdit', });
...
lyr_adm_kabkota_fix_geometri_2.set('fieldLabels', {'OBJECTID': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'LUAS': 'no label', 'GIS_JM_PST': 'no label', 'GIS_NM_INS': 'no label', });
lyr_adm_kabkota_fix_geometri_2.on('precompose', function(evt) {
